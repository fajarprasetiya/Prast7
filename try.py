...
cl = LineClient(authToken="EIWa5D0GrY4jpKI3wzAb.iHJotlxXknz/3GcumMvlkW.YqVXnnkgzVuqj6H4c6wo5KNE37Wt14sQq2QhHVZoEJE=")
...
ki = LineClient(authToken='EHz5Rp9HfLpgzF7lmX86.94czKSyUNkRWChHkhEtn1G.AWU47cqeYfAxRvpM4+rhPviGtyoKiwx5wAJDWZqOBdU=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki,ki.server.CHANNEL_ID['LINE_TIMELINE'])
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='EHwVAzs9agdrNlqwEru8./ZbbyNT1nPqAbluetuyp/a./OO1ojWeUxZaYyz1oykrpHIon9OOQvMu6lOqx6E6Ij0=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk,kk.server.CHANNEL_ID['LINE_TIMELINE'])
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='EHiwxSJuxWx9jMtNXrIc.pK6XbsCUEsyj0pmllefF+a.8up/0O2+qxt0aJ1HTIzx/FwqWvfLs5bN67QuDh6SDGU=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc,kc.server.CHANNEL_ID['LINE_TIMELINE'])
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

kb = LineClient(authToken='EH7H60UxLFPIL12cjWhf.2fkEl5Zc3N6SkcbD3PYW+W.33ZmeU2XurXMlBK9Bf3o1Q164QNB8RKx1QiFcQw1WAA=')
...
ke = LineClient(authToken='EHfVDB0q6CAidy6pZpy3.wfILYTGu+dLq3tl3gzQxaW.PaGN5rfDW/Hy8s+oxMXI11pYpYMYtQsOCj2YJEWsciw=')
...
sw = LineClient(authToken='EHpVpFclEqZKx9iVHwD1.ai48RdHXW+FapYSk/5AIOq.HddMvfO+86cubPry49hmJa+sJb4I2lh1LVUo5rahZjk=')
        ...
        if op.type == 19:
            if mid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ki.kickoutFromGroup(op.param1,[op.param2])
                        ki.inviteIntoGroup(op.param1,[cl,kk,kb,kc,ke])
                        cl.acceptGroupInvitation(op.param1)
                    except:
                        try:
                            kk.kickoutFromGroup(op.param1,[op.param2])
            ...
            if Amid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        kk.kickoutFromGroup(op.param1,[op.param2])
                        kk.inviteIntoGroup(op.param1,[cl,ki,kb,kc,ke])
                        ki.acceptGroupInvitation(op.param1)
                    except:
                        try:
                            kc.kickoutFromGroup(op.param1,[op.param2])
            ...
            if Bmid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        kc.kickoutFromGroup(op.param1,[op.param2])
                        kc.inviteIntoGroup(op.param1,[cl,ki,kk,kb,ke])
                        kk.acceptGroupInvitation(op.param1)
                    except:
                        try:
                            cl.kickoutFromGroup(op.param1,[op.param2])
            ...
            if Cmid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        kb.kickoutFromGroup(op.param1,[op.param2])
                        kb.inviteIntoGroup(op.param1,[cl,ki,kk,kc,ke])
                        kc.acceptGroupInvitation(op.param1)
                    except:
                        try:
                            ki.kickoutFromGroup(op.param1,[op.param2])
            ...
            if Dmid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ke.kickoutFromGroup(op.param1,[op.param2])
                        ke.inviteIntoGroup(op.param1,[cl,ki,kk,kb,kc])
                        kb.acceptGroupInvitation(op.param1)
                    except:
                        try:
                            cl.kickoutFromGroup(op.param1,[op.param2])
            ...
            if Emid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        cl.kickoutFromGroup(op.param1,[op.param2])
                        cl.inviteIntoGroup(op.param1,[ki,kk,kb,kc,ke])
                        ke.acceptGroupInvitation(op.param1)
                    except:
                        try:
                            ki.kickoutFromGroup(op.param1,[op.param2])
                         ...
                         if wait["selfbot"] == True:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                if wait["Timeline"] == False: md+="「🔰」 Timeline「ON」✔\n"
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ginfo = cl.getGroup(msg.to)
                                    cl.inviteIntoGroup(msg.to, [Zmid])
                                    cl.sendMessage(msg.to,"ɢʀᴏᴜᴩ :" +str(ginfo.name)+ "\nsᴛᴀʏ ᴅɪ ʟᴜᴀʀ ᴊᴇɴᴅʀᴀʟ")
                                except:
                                    pass           
